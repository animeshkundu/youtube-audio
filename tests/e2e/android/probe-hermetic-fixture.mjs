 ...
 *
 * The host fixture binds on all interfaces and is mapped to emulator localhost. The BENCH build
 * alone permits that origin, so production permissions remain unchanged.
 */
